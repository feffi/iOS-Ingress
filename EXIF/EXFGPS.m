...
-(NSString*) description{
				...
				NSString* hoursStr = [NSString stringWithFormat:@"%li", (int)hours.numerator/hours.denominator];
				NSString* minutesStr = [NSString stringWithFormat:@"%li", (int)minutes.numerator/minutes.denominator];
				NSString* secondsStr = [NSString stringWithFormat:@"%li", (int)seconds.numerator/seconds.denominator];
