...
- (NSArray *)cellsAsHex {
	...
	NSSet *cellsSet = [NSSet setWithObjects:
	   ...
	   @"47098e8c30000000",	//511877918 4235151360
	   @"47098e8d30000000",	//511877918 8530118656
	   @"47098e8cf0000000",	//511877918 7456376832
	   @"47098e8df0000000",
	   @"47098e8ef0000000",
	   @"47098e8bf0000000",
	   @"47098e8cb0000000",
			...
			for (NSArray *markup in markups) {
				...
				if ([markup[0] isEqualToString:@"PLAYER"] || [markup[0] isEqualToString:@"SENDER"]) {
					...
					if ([markup[1][@"team"] isEqualToString:@"ALIENS"]) {
						[atrstr setAttributes:@{NSFontAttributeName: [UIFont fontWithName:@"Coda-Regular" size:15], NSForegroundColorAttributeName : [UIColor colorWithRed:40./255. green:244./255. blue:40./255. alpha:1]} range:range];
					} else {
						[atrstr setAttributes:@{NSFontAttributeName: [UIFont fontWithName:@"Coda-Regular" size:15], NSForegroundColorAttributeName : [UIColor colorWithRed:0 green:194./255. blue:1 alpha:1]} range:range];
					}
					
				} else if ([markup[0] isEqualToString:@"PORTAL"]) {
					[atrstr setAttributes:@{NSFontAttributeName: [UIFont fontWithName:@"Coda-Regular" size:15], NSForegroundColorAttributeName : [UIColor colorWithRed:0 green:135./255. blue:128./255. alpha:1]} range:range];
					
				} else if ([markup[0] isEqualToString:@"SECURE"]) {
					[atrstr setAttributes:@{NSFontAttributeName: [UIFont fontWithName:@"Coda-Regular" size:15], NSForegroundColorAttributeName : [UIColor colorWithRed:245./255. green:95./255. blue:85./255. alpha:1]} range:range];
				} else {
					
					if (isMessage) {
						[atrstr setAttributes:@{NSFontAttributeName: [UIFont fontWithName:@"Coda-Regular" size:15], NSForegroundColorAttributeName : [UIColor colorWithRed:207./255. green:229./255. blue:229./255. alpha:1]} range:range];
					} else {
						[atrstr setAttributes:@{NSFontAttributeName: [UIFont fontWithName:@"Coda-Regular" size:15], NSForegroundColorAttributeName : [UIColor colorWithRed:0 green:186./255. blue:181./255. alpha:1]} range:range];
					}
